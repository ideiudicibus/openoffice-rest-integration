...
class OfficeConnection implements OfficeContext {
    ...
    public OfficeConnection(String unoUrl) {
        this.unoUrl = unoUrl;
    }
    ...
    public void connect() throws ConnectException {
        ...
        try {
        	UnoUrl unoUrlTmp = UnoUrl.socket(Integer.parseInt(unoUrl));
            ...
            XConnection connection = connector.connect(unoUrlTmp.getConnectString());
            ...
            String bridgeName = "oofficeSpreadsheetBridge_" + bridgeIndex.getAndIncrement();
